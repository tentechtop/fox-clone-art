        ...
        <div className="p-4 flex items-center gap-3">
          <div className="relative">
            ...
            >
              ...
              {sidebarOpen && (
                <ChevronRight className={`h-4 w-4 transition-transform ${showTeamDropdown ? 'rotate-180' : ''}`} />
              )}
            </button>
              ...
              <>
                ...
                <Card>
                  <CardContent className="p-0">
                    <div className="border-b p-4 flex items-center text-sm text-muted-foreground gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                  <Card className="bg-gradient-to-br from-indigo-50 to-purple-50 border-indigo-100">
                    <CardContent className="p-6">
                      ...
                      <p className="text-3xl font-bold text-indigo-700">$0.00</p>
                    </CardContent>
                  </Card>
